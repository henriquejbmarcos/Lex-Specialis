...
reasons = ["F1: N1 is applicable to Sam's case", "F2: N2 is applicable to Sam's case", "F3: N2 is more specific than N1","F4: applying N2 to Sam's case violates the aims of IHL","F5: pro persona"]
...
relationships = [
    ...
    ("F5: pro persona","F4: applying N2 to Sam's case violates the aims of IHL",{'type': 'pro'}),
    ("F5: pro persona","F3: N2 is more specific than N1",{'type': 'con'})
    ]
